...
const ComingSoonBL = ({navigation}) => {
  return (
    ...
    <LottieView 
      ...
      <Pressable style={styles.nextbutton} onPress={() => (navigation.navigate('HomeBL'))}>
            <Text style={styles.textbutton}onPress={() => (navigation.navigate('HomeBL'))}>HOME</Text>
        </Pressable>
    </View>
  )
}
