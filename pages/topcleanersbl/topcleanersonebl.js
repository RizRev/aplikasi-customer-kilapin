...
const TopCleanerOneBL = ({ navigation }) =>  {
  ...
  return (
    <View style={styles.container}>
            ...
            <Text style={{fontFamily: 'Ubuntur', color: '#000', fontSize: 18}}>Top Cleaner 1</Text>
            <Text style={{fontFamily: 'Ubuntu', color: '#000', fontSize: 24, marginVertical: '2%' }}>Sanjayaman</Text>
...
<TouchableOpacity
      onPress={() => navigation.navigate('HomeBL')}
      style={{
    ...
    <ImageBackground source={require("../../assets/image/TopCleanerOne.png")} style={styles.backgroundImage}>
      </ImageBackground>
...
export default TopCleanerOneBL;