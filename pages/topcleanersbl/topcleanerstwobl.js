...
const TopCleanerTwoBL = ({ navigation }) =>  {
  ...
  return (
    <View style={styles.container}>
            ...
            <Text style={{fontFamily: 'Ubuntur', color: '#000', fontSize: 18}}>Top Cleaner 2</Text>
            <Text style={{fontFamily: 'Ubuntu', color: '#000', fontSize: 24, marginVertical: '2%' }}>Kasami</Text>
...
<TouchableOpacity
    ...
    <ImageBackground source={require("../../assets/image/TopCleanerTwo.png")} style={styles.backgroundImage}>
      </ImageBackground>
...
export default TopCleanerTwoBL;